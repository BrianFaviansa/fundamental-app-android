...
import com.faviansa.myreadwritefile.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity(), View.OnClickListener {
    ...
    private fun showList() {
        val items = fileList().filter { fileName -> (fileName != "profileInstalled" && fileName != "rList") }.toTypedArray()
    ...
    private fun saveFile() {
        when {
            ...
            binding.editFile.text.toString().isEmpty() -> Toast.makeText(
                this, "Konten harus diisi terlebih dahulu", Toast.LENGTH_SHORT
            ).show()
